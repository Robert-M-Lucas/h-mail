...
use h_mail_interface::interface::pow::PowResult;
...
use h_mail_interface::interface::email::EmailUser;
use h_mail_interface::interface::email::SendEmailPackage;
...
use h_mail_interface::interface::routes::native::send_email::SolvedPowFor;
...
pub fn all() -> Vec<(Schema, &'static str, Option<&'static str>, Option<(&'static str, RequestMethod, bool)>)> {
    gen_schemas![
        ...
        (EmailUser, Some("email"), None),
        (SendEmailPackage, Some("email"), None),
        ...
        (CreateAccountRequest, Some("routes/native/create_account"), Some((NATIVE_CREATE_ACCOUNT_PATH, NATIVE_CREATE_ACCOUNT_METHOD, NATIVE_CREATE_ACCOUNT_REQUIRES_AUTH))),
        (SendEmailRequest, Some("routes/native/send_email"), Some((NATIVE_SEND_EMAIL_PATH, NATIVE_SEND_EMAIL_METHOD, NATIVE_SEND_EMAIL_REQUIRES_AUTH))),
        (SolvedPowFor, Some("routes/native/send_email"), None),
        (SendEmailResponseAuthed, Some("routes/native/send_email"), None),
        (SendEmailResponse, Some("routes/native/send_email"), None),
        (GetCreateAccountPowPolicyRequest, Some("routes/native/get_create_account_pow_policy"), Some((NATIVE_GET_CREATE_ACCOUNT_POW_POLICY_PATH, NATIVE_GET_CREATE_ACCOUNT_POW_POLICY_METHOD, NATIVE_GET_CREATE_ACCOUNT_POW_POLICY_REQUIRES_AUTH))),
        (GetCreateAccountPowPolicyResponse, Some("routes/native/get_create_account_pow_policy"), None),
        (GetEmailsRequest, Some("routes/native/get_emails"), Some((NATIVE_GET_EMAILS_PATH, NATIVE_GET_EMAILS_METHOD, NATIVE_GET_EMAILS_REQUIRES_AUTH))),
