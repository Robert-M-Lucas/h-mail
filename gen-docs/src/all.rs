...
pub fn all() -> Vec<(Schema, &'static str, Option<&'static str>, Option<(&'static str, RequestMethod, bool)>)> {
    gen_schemas![
        ...
        (AuthenticateRequest, Some("routes\\auth\\authenticate"), Some((AUTH_AUTHENTICATE_PATH, AUTH_AUTHENTICATE_METHOD, AUTH_AUTHENTICATE_REQUIRES_AUTH))),
        (AuthenticateResponse, Some("routes\\auth\\authenticate"), None),
        (CheckAuthRequest, Some("routes\\auth\\check_auth"), Some((AUTH_CHECK_AUTH_PATH, AUTH_CHECK_AUTH_METHOD, AUTH_CHECK_AUTH_REQUIRES_AUTH))),
        (CheckAuthResponseAuthed, Some("routes\\auth\\check_auth"), None),
        (CheckAuthResponse, Some("routes\\auth\\check_auth"), None),
        (RefreshAccessRequest, Some("routes\\auth\\refresh_access"), Some((AUTH_REFRESH_ACCESS_PATH, AUTH_REFRESH_ACCESS_METHOD, AUTH_REFRESH_ACCESS_REQUIRES_AUTH))),
        ...
        (CheckPowRequest, Some("routes\\check_pow"), Some((CHECK_POW_PATH, CHECK_POW_METHOD, CHECK_POW_REQUIRES_AUTH))),
        (DeliverEmailRequest, Some("routes\\foreign\\deliver_email"), Some((FOREIGN_DELIVER_EMAIL_PATH, FOREIGN_DELIVER_EMAIL_METHOD, FOREIGN_DELIVER_EMAIL_REQUIRES_AUTH))),
        (DeliverEmailResponse, Some("routes\\foreign\\deliver_email"), None),
        (GetUserPowPolicyRequest, Some("routes\\foreign\\get_user_pow_policy"), Some((FOREIGN_GET_USER_POW_POLICY_PATH, FOREIGN_GET_USER_POW_POLICY_METHOD, FOREIGN_GET_USER_POW_POLICY_REQUIRES_AUTH))),
        (GetUserPowPolicyResponse, Some("routes\\foreign\\get_user_pow_policy"), None),
        (VerifyIpRequest, Some("routes\\foreign\\verify_ip"), Some((FOREIGN_VERIFY_IP_PATH, FOREIGN_VERIFY_IP_METHOD, FOREIGN_VERIFY_IP_REQUIRES_AUTH))),
        (VerifyIpResponse, Some("routes\\foreign\\verify_ip"), None),
        (GetPowTokenRequest, Some("routes\\get_pow_token"), Some((GET_POW_TOKEN_PATH, GET_POW_TOKEN_METHOD, GET_POW_TOKEN_REQUIRES_AUTH))),
        (GetPowTokenResponse, Some("routes\\get_pow_token"), None),
        (CreateAccountPackage, Some("routes\\native\\create_account"), None),
        (CreateAccountResponse, Some("routes\\native\\create_account"), None),
        (CreateAccountRequest, Some("routes\\native\\create_account"), Some((NATIVE_CREATE_ACCOUNT_PATH, NATIVE_CREATE_ACCOUNT_METHOD, NATIVE_CREATE_ACCOUNT_REQUIRES_AUTH))),
        (GetCreateAccountPowPolicyRequest, Some("routes\\native\\get_create_account_pow_policy"), Some((NATIVE_GET_CREATE_ACCOUNT_POW_POLICY_PATH, NATIVE_GET_CREATE_ACCOUNT_POW_POLICY_METHOD, NATIVE_GET_CREATE_ACCOUNT_POW_POLICY_REQUIRES_AUTH))),
        (GetCreateAccountPowPolicyResponse, Some("routes\\native\\get_create_account_pow_policy"), None),
        (GetEmailsRequest, Some("routes\\native\\get_emails"), Some((NATIVE_GET_EMAILS_PATH, NATIVE_GET_EMAILS_METHOD, NATIVE_GET_EMAILS_REQUIRES_AUTH))),
        (GetEmailsEmail, Some("routes\\native\\get_emails"), None),
        (GetEmailsResponseAuthed, Some("routes\\native\\get_emails"), None),
        (GetEmailsResponse, Some("routes\\native\\get_emails"), None),
        (SendEmailRequest, Some("routes\\native\\send_email"), Some((NATIVE_SEND_EMAIL_PATH, NATIVE_SEND_EMAIL_METHOD, NATIVE_SEND_EMAIL_REQUIRES_AUTH))),
        (SendEmailResponseAuthed, Some("routes\\native\\send_email"), None),
        (SendEmailResponse, Some("routes\\native\\send_email"), None)
    ]
}