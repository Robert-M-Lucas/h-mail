...
use h_mail_client::interface::routes::native::get_foreign_pow_policy::{GetForeignPowPolicyRequest, GetForeignPowPolicyResponseAuthed};
...
#[tauri::command]
pub async fn get_foreign_pow_policy(recipient: HmailAddress) -> InterfaceResult<InterfaceAuthResult<GetForeignPowPolicyResponseAuthed>> {
